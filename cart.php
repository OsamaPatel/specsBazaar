...
<section class="cartbox">
		...
		<div class="prodcart col-md-11 col-lg-11 col-11 main1_cart mb-lg-0 mb-5" >
				...
				<div class="col-6">
					...
					<li class="page-item"><button class="page-link " onclick="decreaseNumber('textbox','itemval')">
					...
					<li class="page-item"><input type="text" name="" class="page-link" value="<?php echo $quantity ?>" id="textbox" ></li>
						<li class="page-item"><button class="page-link" onclick="increaseNumber('textbox','itemval')"> 
		...
		<div class="col-md-12 col-lg-4 col-11 mx-auto mt-lg-0 mt-md-5">
			...
			<div class="right_side p-3 mt-3 bg-white">
				...
				<div class="price_indiv d-flex justify-content-between">
					...
					<?php
                                    ...
                                    $zero=0;
                                ?>
					<p>Rs. <span id="product_total_amt">&#8377;<?php echo $total_revenue ?: $zero;?></span></p>
			...
			<input type="hidden" name="total" value="<?php echo $total_revenue+50??$zero ?>"/>
				...
				<div class="total-amt d-flex justify-content-between font-weight-bold">
					...
					<p>Rs. <span id="total_cart_amt">&#8377;<?php echo $zero+$total_revenue+50?></span></p>
				</div>
		...
		$.ajax({
			...
			success:function(dataResult){
				...
				if(data.is_error=='yes'){
					...
					document.getElementById('total_cart_amt').innerHTML = data.result+50;
				}
			}
		})
	}
