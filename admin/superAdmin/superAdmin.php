    ...
    <div class="wrapper">
        ...
        <form action="" method="POST">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Add Super-Admin" class="addButton">
                    </td>
                </tr>
            </table>
        ...
        <?php
            ...
            if($count>0)
            {
                ...
                <tr>
                    ...
                    <td>
                    <a href="<?php echo SITEURL;?>admin/superAdmin/changeSuperAdminPassword.php?id=<?php echo $id; ?>"><button>Change Password</button></a>
                    <a href="<?php echo SITEURL; ?>admin/superAdmin/updateSuperAdmin.php?id=<?php echo $id; ?>" class="btn-secondary"><button class="updatebtn">
